...
void ch32fs_udc_irq(struct usbd_bus *bus)
{
    ...
    if (intflag & USBFS_UIF_TRANSFER) {
        ...
        memset(g_ch32_usbfs_udc.in_ep, 0, sizeof(struct ch32_usbfs_ep) * CONFIG_CH32FS_BIDIR_ENDPOINTS);
        memset(g_ch32_usbfs_udc.out_ep, 0, sizeof(struct ch32_usbfs_ep) * CONFIG_CH32FS_BIDIR_ENDPOINTS);
